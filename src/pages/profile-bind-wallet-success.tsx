...
type ProfileBindWalletSuccessType = {
  onClose?: () => void;
};

const ProfileBindWalletSuccess: FunctionComponent<
  ProfileBindWalletSuccessType
> = ({ onClose }) => {
  ...
  return (
    <>
      <div className="relative bg-whitesmoke-100 w-full h-screen overflow-hidden flex flex-col items-start justify-start gap-[8px] text-left text-base text-dimgray font-baloo-bhaina-2">
        ...
        <div
          className="my-0 mx-[!important] absolute top-[9px] right-[0px] h-full flex flex-col items-end justify-end py-6 px-4 box-border [&.animate]:animate-[0.25s_ease_0s_1_normal_forwards_slide-in-right] opacity-[0] max-w-[90%] overflow-auto z-[1] font-dm-sans"
          data-animate-on-scroll
        >
          <div className="flex flex-col items-center justify-start">
            <div className="rounded-lg bg-colors-white-100 shadow-[0px_0px_15px_rgba(0,_0,_0,_0.15)] w-[460px] overflow-hidden flex flex-row items-center justify-start py-4 px-8 box-border gap-[8px]">
              <b className="relative inline-block w-[372px] shrink-0">{`Sorry your Update Profile Failed! 😔😔😔  `}</b>
              <img
...
export default ProfileBindWalletSuccess;
