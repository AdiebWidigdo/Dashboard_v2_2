...
const ProfileChangeProfile: FunctionComponent = () => {
    ...
    <>
      <div className="relative bg-whitesmoke-100 w-full h-screen overflow-hidden flex flex-col items-start justify-start text-left text-base text-dimgray font-baloo-bhaina-2">
        <div className="self-stretch flex-1 flex flex-row items-start justify-start gap-[16px]">
          ...
          <div className="self-stretch flex-1 flex flex-col items-center justify-start pt-0 px-0 pb-1 gap-[16px] md:gap-[24px] md:items-center md:justify-between md:pb-0 md:box-border sm:items-center sm:justify-between sm:gap-[0px] sm:pb-0 sm:box-border">
            ...
            <div className="self-stretch h-[695.5px] flex flex-col items-center justify-start py-0 px-4 box-border gap-[24px] md:h-auto sm:h-auto Ultrascreen:flex-1 Ultrascreen:pb-20 Ultrascreen:box-border">
              ...
              <div className="self-stretch rounded-2xl bg-colors-white-100 flex flex-col items-start justify-start p-6 sm:p-5 sm:box-border Ultrascreen:w-[1600px] Ultrascreen:flex-1 Ultrascreen:self-center">
                <div className="self-stretch rounded-2xl flex flex-col items-start justify-start py-4 px-6 gap-[40px] border-[2px] border-dashed border-whitesmoke-400 sm:gap-[48px] sm:pt-4 sm:px-4 sm:pb-10 sm:box-border Ultrascreen:flex-1 Ultrascreen:pl-10 Ultrascreen:pt-6 Ultrascreen:pr-10 Ultrascreen:box-border">
                  ...
                  <div
                    className="flex flex-row items-start justify-start gap-[8px] cursor-pointer text-sm font-dm-sans"
...
export default ProfileChangeProfile;
