...
const MemoryFragment: FunctionComponent = () => {
  ...
  const onPrimaryButtonContainerClick = useCallback(() => {
    navigate("/prototypedashboardconvertmemoryfragment1");
  }, [navigate]);
  ...
  return (
    <>
      <div className="relative bg-whitesmoke-100 w-full h-screen overflow-hidden flex flex-col items-start justify-start text-left text-base text-dimgray font-baloo-bhaina-2 md:items-center md:justify-start">
        <div className="self-stretch flex-1 flex flex-row items-start justify-start gap-[16px] sm:items-center sm:justify-center">
          ...
          <div className="self-stretch flex-1 flex flex-col items-center justify-start pt-0 px-0 pb-1 gap-[16px] md:gap-[24px] md:items-center md:justify-between sm:gap-[4px] sm:items-center sm:justify-between sm:pb-0 sm:box-border Ultrascreen:pb-20 Ultrascreen:box-border">
                ...
                <div className="self-stretch rounded-2xl flex flex-col items-start justify-start p-6 gap-[16px] border-[2px] border-dashed border-whitesmoke-400 md:w-auto md:[align-self:unset] md:items-center md:justify-start sm:h-auto sm:items-center sm:justify-start sm:py-4 sm:px-2 sm:box-border Ultrascreen:flex-1 Ultrascreen:items-center Ultrascreen:justify-start Ultrascreen:pl-10 Ultrascreen:pr-10 Ultrascreen:box-border">
                  ...
                  <div className="flex flex-row items-start justify-center gap-[8px] font-dm-sans sm:self-stretch sm:w-auto sm:flex-1 sm:flex-col sm:gap-[16px] sm:items-center sm:justify-start">
                    <div className="rounded-2xl bg-colors-white-100 shadow-[0px_3.5px_5.5px_rgba(0,_0,_0,_0.02)] hidden flex-row items-center justify-start border-[1px] border-solid border-whitesmoke-300 sm:flex sm:w-auto sm:[align-self:unset]">
                      <div className="rounded-lg w-[120px] h-[200px] flex flex-col items-center justify-center bg-[url('/public/previewmobile11@3x.png')] bg-cover bg-no-repeat bg-[top] lg:hidden md:hidden sm:flex sm:w-[120px] sm:h-[216px]">
                        <img
                    ...
                    <div className="flex flex-col items-center justify-start gap-[16px] text-sm text-colors-white-100">
                      ...
                      <div className="self-stretch flex flex-row items-start justify-start gap-[8px] lg:gap-[4px] lg:items-center lg:justify-center sm:flex-col sm:gap-[8px]">
                        <div
                          className="rounded-lg bg-royalblue h-8 flex flex-row items-center justify-center py-0 px-3 box-border gap-[8px] cursor-pointer hover:bg-steelblue active:bg-darkslategray-200 lg:w-auto lg:[align-self:unset] lg:gap-[4px] lg:pl-4 lg:pr-4 lg:box-border md:pl-4 md:pr-4 md:box-border sm:self-stretch sm:w-auto sm:h-8 sm:gap-[8px]"
                        ...
                        <div className="flex-1 flex flex-row items-start justify-start gap-[8px] sm:gap-[4px] sm:items-start sm:justify-center sm:flex-[unset] sm:self-stretch">
                          <div className="rounded-lg bg-dimgray h-8 flex flex-row items-center justify-center py-0 px-3 box-border gap-[8px] lg:pl-4 lg:pr-4 lg:box-border md:gap-[0px] md:pl-2 md:pr-2 md:box-border sm:flex-1 sm:h-8 sm:gap-[8px]">
                            <img
                              className="relative w-5 h-5 overflow-hidden shrink-0 lg:w-5 lg:h-5"
                              alt=""
                    ...
                    <div className="rounded-lg bg-colors-white-100 shadow-[0px_3.5px_5.5px_rgba(0,_0,_0,_0.02)] flex flex-col items-start justify-start gap-[8px] text-xl border-[1px] border-solid border-whitesmoke-300 md:flex sm:hidden">
                      <div className="rounded-lg w-[276px] h-60 flex flex-col items-center justify-center bg-[url('/public/preview11@3x.png')] bg-cover bg-no-repeat bg-[top]">
                        <img
                          className="relative w-40 h-40 object-cover"
                          alt=""
                          src="/achievementflag1-221@2x.png"
                        />
                      </div>
