    ...
    <>
      <div className="relative bg-whitesmoke-100 w-full h-screen overflow-hidden flex flex-col items-start justify-start text-left text-base text-dimgray font-baloo-bhaina-2 md:items-center md:justify-start">
        <div className="self-stretch flex-1 flex flex-row items-start justify-start gap-[16px]">
          ...
          <div className="self-stretch flex-1 flex flex-col items-center justify-start pt-0 px-0 pb-1 gap-[16px] md:gap-[24px] md:items-center md:justify-between sm:items-center sm:justify-between sm:gap-[0px] sm:pb-0 sm:box-border Ultrascreen:self-stretch Ultrascreen:h-auto Ultrascreen:pb-20 Ultrascreen:box-border">
            ...
            <div className="self-stretch h-[695.5px] flex flex-col items-center justify-start py-0 px-4 box-border gap-[24px] sm:h-auto sm:pl-2 sm:pr-4 sm:box-border Ultrascreen:flex-1">
              ...
              <div className="self-stretch rounded-2xl bg-colors-white-100 flex flex-col items-start justify-center p-6 md:w-auto md:[align-self:unset] sm:p-2 sm:box-border Ultrascreen:w-[1600px] Ultrascreen:flex-1 Ultrascreen:items-center Ultrascreen:justify-start Ultrascreen:self-center">
                <div className="self-stretch rounded-2xl flex flex-col items-start justify-start p-6 gap-[16px] border-[2px] border-dashed border-whitesmoke-400 md:w-auto md:[align-self:unset] md:items-center md:justify-start sm:py-4 sm:px-2 sm:box-border Ultrascreen:flex-1 Ultrascreen:items-center Ultrascreen:justify-start Ultrascreen:pl-10 Ultrascreen:pr-10 Ultrascreen:box-border">
                  ...
                  <div className="flex flex-row items-start justify-center gap-[8px] font-dm-sans sm:self-stretch sm:w-auto sm:flex-1 sm:flex-col sm:gap-[16px] sm:items-center sm:justify-start">
                    ...
                    <div className="flex flex-col items-center justify-start gap-[16px] text-sm">
                      ...
                      <div className="self-stretch flex flex-row items-start justify-start gap-[16px] md:self-stretch md:w-auto sm:flex-col sm:gap-[4px]">
                        <div
