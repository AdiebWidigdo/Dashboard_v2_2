...
const ProfileBindWallet: FunctionComponent = () => {
  ...
  return (
    <>
      <div className="bg-whitesmoke-100 w-[1200px] h-screen overflow-hidden flex flex-col items-start justify-start relative gap-[8px] text-left text-base text-dimgray font-baloo-bhaina-2">
        <div className="self-stretch flex-1 flex flex-row items-start justify-start gap-[16px] z-[0]">
          ...
          <div className="self-stretch flex-1 flex flex-col items-center justify-start pt-0 px-0 pb-1 gap-[16px] md:gap-[24px] md:items-center md:justify-between md:pb-0 md:box-border sm:items-center sm:justify-between sm:gap-[0px] sm:pb-0 sm:box-border Ultrascreen:pb-20 Ultrascreen:box-border">
            ...
            <div className="self-stretch h-[695.5px] flex flex-col items-center justify-start py-0 px-4 box-border gap-[24px] md:h-auto sm:h-auto Ultrascreen:flex-1">
              ...
              <div className="self-stretch rounded-2xl bg-colors-white-100 flex flex-col items-start justify-start p-6 sm:p-5 sm:box-border Ultrascreen:w-[1600px] Ultrascreen:flex-1 Ultrascreen:self-center">
                <div className="self-stretch rounded-2xl flex flex-col items-start justify-start py-4 px-6 gap-[40px] border-[2px] border-dashed border-whitesmoke-400 sm:gap-[48px] sm:pt-4 sm:px-4 sm:pb-10 sm:box-border Ultrascreen:flex-1 Ultrascreen:pl-10 Ultrascreen:pt-6 Ultrascreen:pr-10 Ultrascreen:box-border">
                  ...
                  <section className="self-stretch flex flex-col items-start justify-start gap-[8px] text-left text-sm text-dimgray font-baloo-2">
                    ...
                    <div className="flex flex-col items-start justify-start gap-[8px] sm:gap-[0px]">
                      ...
                      <div className="rounded-lg bg-mediumseagreen h-8 flex flex-row items-center justify-end py-0 px-6 box-border text-colors-white-100 font-dm-sans sm:h-8 sm:rounded-lg sm:pl-4 sm:pr-4 sm:box-border">
                  ...
                  <div className="flex flex-row items-start justify-start gap-[8px] text-sm font-dm-sans">
                    <button className="cursor-pointer [border:none] py-0 px-16 bg-dimgray rounded-lg w-[120px] h-8 flex flex-row items-center justify-center box-border sm:w-[120px] sm:h-8 sm:rounded-lg sm:pt-0 sm:box-border">
                      <b className="relative text-sm tracking-[0.02em] leading-[100%] font-dm-sans text-colors-white-100 text-center sm:text-xs">
                        Submit
                      </b>
                    </button>
                    <div className="rounded-lg box-border w-[120px] h-8 flex flex-row items-center justify-center py-0 px-6 mix-blend-normal border-[1px] border-solid border-dimgray md:w-[120px] md:h-8 sm:w-[120px]">
                      <b className="relative tracking-[0.02em] leading-[100%] sm:text-xs">
                        Cancel
                      </b>
                    </div>
        ...
        <img
          className="absolute my-0 mx-[!important] top-[0px] right-[0px] rounded-t-none rounded-b-mid w-[408px] h-[735px] object-cover z-[1]"
          alt=""
          src="/image-28@2x.png"
        />
      </div>
...
export default ProfileBindWallet;
