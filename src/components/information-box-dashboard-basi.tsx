...
import DrawerMenuSlide from "./drawer-menu-slide";
import PortalDrawer from "./portal-drawer";
import WalletMenu from "./wallet-menu";

const InformationBoxDashboardBasi: FunctionComponent = () => {
  ...
  return (
    <>
      <div className="bg-whitesmoke-100 w-[1200px] h-screen overflow-hidden flex flex-col items-start justify-start text-left text-base text-dimgray font-baloo-bhaina-2 sm:w-auto sm:[align-self:unset] sm:h-screen">
        <div className="self-stretch flex-1 flex flex-row items-start justify-start gap-[16px] lg:flex-1 md:flex-1 sm:flex-1 sm:gap-[8px]">
          ...
          <div className="self-stretch flex-1 flex flex-col items-center justify-between md:gap-[16px] sm:gap-[8px] sm:items-center sm:justify-between Ultrascreen:pb-6 Ultrascreen:box-border">
            ...
            <div className="self-stretch flex flex-col items-center justify-start py-0 px-4 gap-[24px] lg:h-auto md:h-auto md:gap-[16px] sm:w-auto sm:[align-self:unset] sm:h-auto sm:gap-[8px] sm:pl-2 sm:pr-2 sm:box-border Ultrascreen:flex-1 Ultrascreen:pb-20 Ultrascreen:box-border">
              ...
              <div className="self-stretch rounded-2xl bg-colors-white-100 flex flex-col items-start justify-start p-6 lg:h-auto md:p-4 md:box-border sm:w-auto sm:[align-self:unset] sm:items-center sm:justify-center sm:p-2 sm:box-border Ultrascreen:w-[1600px] Ultrascreen:flex-1 Ultrascreen:items-center Ultrascreen:justify-center Ultrascreen:pl-6 Ultrascreen:pb-6 Ultrascreen:box-border Ultrascreen:self-center">
                <div className="self-stretch rounded-2xl flex flex-col items-start justify-start p-4 relative gap-[16px] border-[2px] border-dashed border-whitesmoke-400 sm:gap-[0px] sm:py-2 sm:px-1 sm:box-border Ultrascreen:flex-1 Ultrascreen:items-center Ultrascreen:justify-center Ultrascreen:pl-10 Ultrascreen:pt-6 Ultrascreen:pr-10 Ultrascreen:box-border">
                  <div className="self-stretch rounded-2xl flex flex-col items-start justify-start p-4 gap-[16px] z-[0] sm:hidden sm:pt-0 sm:pb-0 sm:box-border Ultrascreen:flex-1">
                  ...
                  <div className="hidden flex-col items-center justify-start gap-[8px] z-[1] sm:flex">
                    <img
                    ...
                    >
                      <div className="w-80 h-[58.7px] flex flex-row items-center justify-center gap-[8px] bg-[url('/public/frame-4286@3x.png')] bg-cover bg-no-repeat bg-[top]">
                        ...
                        <img
                          className="relative w-[156px] h-[58.7px] object-cover"
                          alt=""
                          src="/achievementflag1-341@2x.png"
                        />
                      </div>
                      <div className="self-stretch flex flex-row items-center justify-center py-0 px-4 gap-[8px]">
                        <img
                  ...
                  <img
                    className="absolute my-0 mx-[!important] top-[364px] right-[309px] w-6 h-6 overflow-hidden shrink-0 z-[2] sm:w-6 sm:h-6"
                    alt=""
                    src="/phinfobold1.svg"
                  />
                  <img
                    className="absolute my-0 mx-[!important] top-[364px] right-[40px] w-6 h-6 overflow-hidden shrink-0 z-[3] sm:w-6 sm:h-6"
                    alt=""
                    src="/phinfobold1.svg"
                  />
                  <img
                    className="absolute my-0 mx-[!important] top-[364px] right-[576px] w-6 h-6 overflow-hidden shrink-0 z-[4] sm:w-6 sm:h-6"
                    alt=""
                    src="/phinfobold1.svg"
                  />
                  <div className="my-0 mx-[!important] absolute top-[391px] left-[259px] rounded-lg bg-colors-white-100 shadow-[0px_0px_15px_rgba(0,_0,_0,_0.15)] overflow-hidden flex flex-row items-center justify-center py-2 px-6 z-[5] text-xs font-dm-sans sm:hidden">
                    <div className="relative leading-[160%] font-medium flex items-center w-[298px] h-[62px] shrink-0 lg:text-sm">
                      These are the Bookmark Banners that you have placed down
                      and are ready to be transmuted.
                    </div>
                  </div>
                </div>
              </div>
            </div>
            <section className="self-stretch flex flex-row items-end justify-between py-1 px-6 text-left text-xs text-darkgray font-baloo-bhaina-2 md:hidden sm:hidden">
...
export default InformationBoxDashboardBasi;
