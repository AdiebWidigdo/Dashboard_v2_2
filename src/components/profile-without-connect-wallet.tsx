...
const ProfileWithoutConnectWallet: FunctionComponent = () => {
  ...
  return (
    <>
      <div className="bg-whitesmoke-100 w-[1200px] h-screen overflow-hidden flex flex-col items-start justify-start text-left text-base text-dimgray font-baloo-bhaina-2">
...
export default ProfileWithoutConnectWallet;
